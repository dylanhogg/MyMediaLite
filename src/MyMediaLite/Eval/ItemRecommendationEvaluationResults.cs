    ...
    public class ItemRecommendationEvaluationResults : Dictionary<string, float>
    {
        ...
        public override string ToString()
        {
            string s = string.Format(
                ...
                "AUC {0:0.#####} prec@3 {1:0.#####} prec@5 {2:0.#####} prec@10 {3:0.#####} MAP {4:0.#####} recall@3 {5:0.#####} recall@5 {6:0.#####} recall@10 {7:0.#####} NDCG {8:0.#####} MRR {9:0.#####} num_users {10} num_items {11} num_lists {12}",
                this["AUC"], this["prec@3"], this["prec@5"], this["prec@10"], this["MAP"], this["recall@3"], this["recall@5"], this["recall@10"], this["NDCG"], this["MRR"], this["num_users"], this["num_items"], this["num_lists"]
            );
